      ...
      <ScrollView style={styles.container}>
        ...
        <View style={{ flex: 1 }}>
          <View
            ...
            <Image
              source={require('C:/Users/Administrator/react-native/Refrigerator-recipe/Refrigerator-Recipe/imageSrc/fried.jpg')}
              style={{
                width: wp(50),
                height: hp(10),
                resizeMode: 'contain',
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.topArea}>
        <View style={styles.titleArea}>
          <Image
            source={require('C:/Users/Administrator/react-native/Refrigerator-recipe/Refrigerator-Recipe/imageSrc/register2.jpg')}
